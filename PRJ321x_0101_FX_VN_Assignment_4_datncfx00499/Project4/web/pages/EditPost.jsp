        ...
        <div class="row sticky-top">
          ...
          <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="text-editor-icons pb-2 pt-1 pl-2">
              ...
              <input id="text-color" type="color" onchange="execCmdWithArg('foreColor', this.value)"/>
              <label>Background Color</label>
              <input id="background-color" type="color" onchange="execCmdWithArg('hiliteColor', this.value)"/>
