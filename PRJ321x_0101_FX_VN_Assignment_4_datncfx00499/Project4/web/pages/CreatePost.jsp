...
<html>
  ...
  <body onload="enableEditMode();">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
          <form id="submitPost" method="post" action="index.jsp">
            <input style="display:none;" name="content" class="content"></input>
            <iframe name="richTextField" style="width: 100%; height: auto" id="richTextField"></iframe>
          </form>
